    ...
    <div class="wrapper">
        ...
        <main class="content">
            <div class="container-fluid p-0">
               <!-- <h1 class="h3 mb-3"><strong>Raport</strong> abonați</h1> -->
                <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body" id="print">
                                            ...
                                            <h1 class="h3 mb-3"><strong>Raport</strong> abonați</h1>
                                            <?php
                                            $x = mysqli_query($con, "SELECT * FROM Abonat ORDER BY ID;");
                                        ...
                                        <script type="text/javascript">
                                            function abonati() {
                                                ...
                                                var opt = {
                                                    margin: 0.3,
                                                    filename: `raport abonati ${new Date().toISOString().slice(0, 10)}`,
                                        ...
                                        <center>
                                            <button onclick="abonati()" id="exportButton"
