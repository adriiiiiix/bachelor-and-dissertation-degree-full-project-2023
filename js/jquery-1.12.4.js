...
!function (e, t) {
    ...
    var n = [], r = e.document, i = n.slice, o = n.concat, a = n.push, s = n.indexOf, l = {}, u = l.toString,
        c = l.hasOwnProperty, f = {}, d = "1.12.4", p = function (e, t) {
    ...
    p.fn = p.prototype = {
        jquery: d, constructor: p, selector: "", length: 0, toArray: function () {
            return i.call(this)
        }, get: function (e) {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || p.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (i = arguments[s])) for (r in i) e = a[r], a !== (n = i[r]) && (u && n && (p.isPlainObject(n) || (t = p.isArray(n))) ? (t ? (t = !1, o = e && p.isArray(e) ? e : []) : o = e && p.isPlainObject(e) ? e : {}, a[r] = p.extend(u, o, n)) : void 0 !== n && (a[r] = n));
        return a
    }, p.extend({
        expando: "jQuery" + (d + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, r = 0;
            if (y(e)) for (n = e.length; r < n && !1 !== t.call(e[r], r, e[r]); r++) ; else for (r in e) if (!1 === t.call(e[r], r, e[r])) break;
            return e
        }, trim: function (e) {
    ...
    var x = function (e) {
        var t, n, r, i, o, a, s, l, u, c, f, d, p, h, g, m, v, y, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0,
        ...
        function ie(e, t, r, i) {
            var o, s, u, c, f, h, v, y, T = t && t.ownerDocument, C = t ? t.nodeType : 9;
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (x = (p = (u = (c = (f = (d = m)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && u[1]) && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (x = p = 0) || h.pop();) if (1 === d.nodeType && ++x && d === t) {
                                    c[e] = [T, p, x];
                                    break
                                }
                            } else if (y && (x = p = (u = (c = (f = (d = t)[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && u[1]), !1 === x) for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++x || (y && ((c = (f = d[b] || (d[b] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [T, x]), d !== t));) ;
        ...
        function xe(e, t, n, r, i, o) {
            return r && !r[b] && (r = xe(r)), i && !i[b] && (i = xe(i, o)), ae(function (o, a, s, l) {
                var u, c, f, d = [], p = [], h = a.length, g = o || function (e, t, n) {
                        ...
                        return n
                    }(t || "*", s.nodeType ? [s] : s, []), m = !e || !o && t ? g : ye(g, d, e, s, l),
                    v = n ? i || (o ? e : h || r) ? [] : a : m;
                if (n && n(m, v, s, l), r) for (u = ye(v, p), r(u, [], s, l), c = u.length; c--;) (f = u[c]) && (v[p[c]] = !(m[p[c]] = f));
                if (o) {
                    if (i || e) {
                        if (i) {
        ...
        function be(e) {
            for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], l = a ? 1 : 0, c = me(function (e) {
                ...
                return t = null, i
            }]; l < o; l++) if (n = r.relative[e[l].type]) d = [me(ve(d), n)]; else {
                if ((n = r.filter[e[l].type].apply(null, e[l].matches))[b]) {
                    for (i = ++l; i < o && !r.relative[e[i].type]; i++) ;
                    return xe(l > 1 && ve(d), l > 1 && ge(e.slice(0, l - 1).concat({value: " " === e[l - 2].type ? "*" : ""})).replace(I, "$1"), n, l < i && be(e.slice(l, i)), i < o && be(e = e.slice(i)), i < o && ge(e))
                }
                d.push(n)
            }
            return ve(d)
        ...
        return he.prototype = r.filters = r.pseudos, r.setFilters = new he, a = ie.tokenize = function (e, t) {
            ...
            if (i = i || [], 1 === h.length) {
                ...
                for (l = Y.needsContext.test(e) ? 0 : u.length; l-- && (c = u[l], !r.relative[f = c.type]);) if ((d = r.find[f]) && (o = d(c.matches[0].replace(te, ne), Z.test(u[0].type) && pe(t.parentNode) || t))) {
    ...
    (p.fn.init = function (e, t, n) {
        ...
        if (n = n || k, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof p ? t[0] : t, p.merge(this, p.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0)), C.test(i[1]) && p.isPlainObject(t)) for (i in t) p.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    p.Callbacks = function (e) {
        ...
        var r, i, o, a, s = [], l = [], u = -1, c = function () {
            for (a = e.once, o = r = !0; l.length; u = -1) for (i = l.shift(); ++u < s.length;) !1 === s[u].apply(i[0], i[1]) && e.stopOnFalse && (u = s.length, i = !1);
            ...
            add: function () {
                ...
                return p.each(arguments, function (e, t) {
                    for (var n; (n = p.inArray(t, s, n)) > -1;) s.splice(n, 1), n <= u && u--
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            if (s > 1) for (t = new Array(s), n = new Array(s), r = new Array(s); o < s; o++) a[o] && p.isFunction(a[o].promise) ? a[o].promise().progress(c(o, n, t)).done(c(o, r, a)).fail(u.reject) : --l;
        ...
        if (!L) if (L = p.Deferred(), "complete" === r.readyState || "loading" !== r.readyState && !r.documentElement.doScroll) e.setTimeout(p.ready); else if (r.addEventListener) r.addEventListener("DOMContentLoaded", F), e.addEventListener("load", F); else {
    ...
    function I(e, t, r, i) {
        if (O(e)) {
            ...
            if (c && u[c] && (i || u[c].data) || void 0 !== r || "string" != typeof t) return c || (c = l ? e[s] = n.pop() || p.guid++ : s), u[c] || (u[c] = l ? {} : {toJSON: p.noop}), "object" != typeof t && "function" != typeof t || (i ? u[c] = p.extend(u[c], t) : u[c].data = p.extend(u[c].data, t)), a = u[c], i || (a.data || (a.data = {}), a = a.data), void 0 !== r && (a[p.camelCase(t)] = r), "string" == typeof t ? null == (o = a[t]) && (o = a[p.camelCase(t)]) : o = a, o
        }
    }
    ...
    function ae(e, t) {
        ...
        if (!o) for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || p.nodeName(r, t) ? o.push(r) : p.merge(o, ae(r, t));
    ...
    function fe(e, t, n, r, i) {
        for (var o, a, s, l, u, c, d, h = e.length, g = ie(t), m = [], v = 0; v < h; v++) if ((a = e[v]) || 0 === a) if ("object" === p.type(a)) p.merge(m, a.nodeType ? [a] : a); else if (le.test(a)) {
            ...
            if (!f.leadingWhitespace && ne.test(a) && m.push(t.createTextNode(ne.exec(a)[0])), !f.tbody) for (o = (a = "table" !== u || ue.test(a) ? "<table>" !== d[1] || ue.test(a) ? 0 : l : l.firstChild) && a.childNodes.length; o--;) p.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
            for (p.merge(m, l.childNodes), l.textContent = ""; l.firstChild;) l.removeChild(l.firstChild);
            l = g.lastChild
        } else m.push(t.createTextNode(a));
        for (l && g.removeChild(l), f.appendChecked || p.grep(ae(m, "input"), ce), v = 0; a = m[v++];) if (r && p.inArray(a, r) > -1) i && i.push(a); else if (s = p.contains(a.ownerDocument, a), l = ae(g.appendChild(a), "script"), s && se(l), n) for (o = 0; a = l[o++];) te.test(a.type || "") && n.push(a);
        return l = null, g
    }
    ...
    function be(e, t, n, r, i, o) {
        ...
        if (null == r && null == i ? (i = n, r = n = void 0) : null == i && ("string" == typeof n ? (i = r, r = void 0) : (i = r, r = n, n = void 0)), !1 === i) i = ye; else if (!i) return e;
    ...
    p.event = {
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (v && (c = v.events)) {
                for (u = (t = (t || "").match(q) || [""]).length; u--;) if (h = m = (s = me.exec(t[u]) || [])[1], g = (s[2] || "").split(".").sort(), h) {
        ...
        trigger: function (t, n, i, o) {
            var a, s, l, u, f, d, h, g = [i || r], m = c.call(t, "type") ? t.type : t,
            ...
            if (l = d = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !ge.test(m + p.event.triggered) && (m.indexOf(".") > -1 && (m = (v = m.split(".")).shift(), v.sort()), s = m.indexOf(":") < 0 && "on" + m, (t = t[p.expando] ? t : new p.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = v.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : p.makeArray(n, [t]), f = p.event.special[m] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                ...
                for (h = 0; (l = g[h++]) && !t.isPropagationStopped();) t.type = h > 1 ? u : f.bindType || m, (a = (p._data(l, "events") || {})[t.type] && p._data(l, "handle")) && a.apply(l, n), (a = s && l[s]) && a.apply && O(l) && (t.result = a.apply(l, n), !1 === t.result && t.preventDefault());
        ...
        dispatch: function (e) {
            e = p.event.fix(e);
            var t, n, r, o, a, s, l = i.call(arguments), u = (p._data(this, "events") || {})[e.type] || [],
    ...
    }), f.focusin || p.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
    ...
    function _e(e, t, n, r) {
        t = o.apply([], t);
        var i, a, s, l, u, c, d = 0, h = e.length, g = h - 1, m = t[0], v = p.isFunction(m);
        ...
        if (h && (i = (c = fe(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === c.childNodes.length && (c = i), i || r)) {
            ...
            if (s) for (u = l[l.length - 1].ownerDocument, p.map(l, Le), d = 0; d < s; d++) a = l[d], te.test(a.type || "") && !p._data(a, "globalEval") && p.contains(u, a) && (a.src ? p._evalUrl && p._evalUrl(a.src) : p.globalEval((a.text || a.textContent || a.innerHTML || "").replace(Se, "")));
            c = i = null
        }
        return e
    }
    ...
    p.extend({
        htmlPrefilter: function (e) {
            ...
            if (f.html5Clone || p.isXMLDoc(e) || !Te.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ae.innerHTML = e.outerHTML, Ae.removeChild(o = Ae.firstChild)), !(f.noCloneEvent && f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || p.isXMLDoc(e))) for (r = ae(o), s = ae(e), a = 0; null != (i = s[a]); ++a) r[a] && qe(i, r[a]);
            ...
            for (var r, i, o, a, s = 0, l = p.expando, u = p.cache, c = f.attributes, d = p.event.special; null != (r = e[s]); s++) if ((t || O(r)) && (a = (o = r[l]) && u[o])) {
    ...
    !function () {
        ...
        function c() {
            ...
            d.appendChild(l), u.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", t = i = s = !1, n = a = !0, e.getComputedStyle && (f = e.getComputedStyle(u), t = "1%" !== (f || {}).top, s = "2px" === (f || {}).marginLeft, i = "4px" === (f || {width: "4px"}).width, u.style.marginRight = "50%", n = "4px" === (f || {marginRight: "4px"}).marginRight, (c = u.appendChild(r.createElement("div"))).style.cssText = u.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", c.style.marginRight = c.style.width = "0", u.style.width = "1px", a = !parseFloat((e.getComputedStyle(c) || {}).marginRight), u.removeChild(c)), u.style.display = "none", (o = 0 === u.getClientRects().length) && (u.style.display = "", u.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", u.childNodes[0].style.borderCollapse = "separate", (c = u.getElementsByTagName("td"))[0].style.cssText = "margin:0;border:0;padding:0;display:none", (o = 0 === c[0].offsetHeight) && (c[0].style.display = "", c[1].style.display = "none", o = 0 === c[0].offsetHeight)), d.removeChild(l)
        }
    ...
    p.extend({
        ...
        get: function (e, t) {
            ...
            var n = e.style, r = e.currentStyle, i = p.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
        ...
        if (t) return (parseFloat(Xe(e, "marginLeft")) || (p.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - Ie(e, {marginLeft: 0}, function () {
    ...
    var lt, ut, ct, ft, dt, pt, ht, gt = /^(?:toggle|show|hide)$/, mt = /queueHooks$/;
    ...
    function bt(e, t, n) {
        var r, i, o = 0, a = bt.prefilters.length, s = p.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (i) return !1;
        ...
        for (!function (e, t) {
            var n, r, i, o, a;
            for (n in e) if (i = t[r = p.camelCase(n)], o = e[n], p.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = p.cssHooks[r]) && "expand" in a) {
                o = a.expand(o), delete e[r];
                for (n in o) n in e || (e[n] = o[n], t[n] = i)
            } else t[r] = i
        }(c, u.opts.specialEasing); o < a; o++) if (r = bt.prefilters[o].call(u, e, c, u.opts)) return p.isFunction(r.stop) && (p._queueHooks(u.elem, u.opts.queue).stop = p.proxy(r.stop, r)), r;
    ...
    p.Animation = p.extend(bt, {
        tweeners: {
            ...
            var r, i, o, a, s, l, u, c = this, d = {}, h = e.style, g = e.nodeType && V(e), m = p._data(e, "fxshow");
            ...
            if (p.isEmptyObject(d)) "inline" === ("none" === u ? Pe(e.nodeName) : u) && (h.display = u); else {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = p._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = p.timers,
                    a = r ? r.length : 0;
    ...
    p.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], s = o ? i + 1 : r.length, l = i < 0 ? s : o ? i : 0; l < s; l++) if (((n = r[l]).selected || l === i) && (f.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !p.nodeName(n.parentNode, "optgroup"))) {
                        if (t = p(n).val(), o) return t;
                        a.push(t)
                    }
                    return a
                }, set: function (e, t) {
                    for (var n, r, i = e.options, o = p.makeArray(t), a = i.length; a--;) if (r = i[a], p.inArray(p.valHooks.option.get(r), o) > -1) try {
                        r.selected = n = !0
                    } catch (e) {
                        r.scrollHeight
                    } else r.selected = !1;
    ...
    var Ct, Et, Nt = p.expr.attrHandle, kt = /^(?:checked|selected)$/i, St = f.getSetAttribute, At = f.input;
    p.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            if (o && 1 === e.nodeType) for (; n = o[i++];) r = p.propFix[n] || n, p.expr.match.bool.test(n) ? At && St || !kt.test(n) ? e[r] = !1 : e[p.camelCase("default-" + n)] = e[r] = !1 : p.attr(e, n, ""), e.removeAttribute(St ? n : r)
        }
    }), Et = {
        set: function (e, t, n) {
    ...
    p.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(q) || []; n = this[l++];) if (i = Ht(n), r = 1 === n.nodeType && (" " + i + " ").replace(Lt, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : p.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n) for (r = 0, i = p(this), o = e.match(q) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = Ht(this)) && p._data(this, "__className__", t), p.attr(this, "class", t || !1 === e ? "" : p._data(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && (" " + Ht(n) + " ").replace(Lt, " ").indexOf(t) > -1) return !0;
            return !1
        }
    ...
    p.extend({
        ...
        ajax: function (t, n) {
            ...
            var r, i, o, a, s, l, u, c, f = p.ajaxSetup({}, n), d = f.context || f,
                h = f.context && (d.nodeType || d.jquery) ? p(d) : p.event, g = p.Deferred(),
                m = p.Callbacks("once memory"), v = f.statusCode || {}, y = {}, x = {}, b = 0, w = "canceled", T = {
    ...
    function nn(e, t, n, r) {
        ...
        }); else if (n || "object" !== p.type(t)) r(e, t); else for (i in t) nn(e + "[" + i + "]", t[i], n, r)
    }
    ...
    var rn = 0, on = {}, an = p.ajaxSettings.xhr();
        ...
        if (!t.crossDomain || f.cors) return {
            send: function (r, i) {
                ...
                a.send(t.hasContent && t.data || null), n = function (e, r) {
                    var o, l, u;
                    if (n && (r || 4 === a.readyState)) if (delete on[s], n = void 0, a.onreadystatechange = p.noop, r) 4 !== a.readyState && a.abort(); else {
    ...
    p.ajaxSetup({
        ...
        var i, o, a,
            s = !1 !== t.jsonp && (cn.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && cn.test(t.data) && "data");
    ...
    p.fn.load = function (e, t, n) {
        ...
        setOffset: function (e, t, n) {
            var r, i, o, a, s, l, u = p.css(e, "position"), c = p(e), f = {};
...
(function (e) {
    ...
    e(document).mouseup(function () {
        ...
        e.position = {
            ...
            n = e.extend({}, n);
            var p, m, g, v, y, b, _ = e(n.of), x = e.position.getWithinInfo(n.within), k = e.position.getScrollInfo(x),
                w = (n.collision || "flip").split(" "), T = {};
    ...
    e.extend(n.prototype, {
        ...
        _generateHTML: function (e) {
            var t, i, s, n, a, o, r, h, l, u, d, c, p, f, m, g, v, y, b, _, x, k, w, T, D, S, M, N, C, A, P, I, H, z, F,
                j, E, O, W, L = new Date,
                ...
                V = this._get(e, "showCurrentAtPos"), q = this._get(e, "stepMonths"), U = 1 !== K[0] || 1 !== K[1],
