    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Modifică</strong> produs</h1>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <!-- <form action="modificaprodus.php" method="POST" enctype="multipart/form-data">-->
                                            <form id="form">
                                                <div class="mb-3">
...
<script>
    function onsubmit(event) {
        ...
        fetch("modificaprodus.php", {method: "post", body: data})
