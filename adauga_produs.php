    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Adaugă</strong> produs</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='management-evidenta_produse.php'"><b>ÎNAPOI</b>
                                            </button>
                                        </div>
                                        <div class="card-body">
                                            <!-- <form action="adaugaprodus.php" method="POST" enctype="multipart/form-data"> -->
                                            <form id="form">
                                                <div class="mb-3">
                                                    <label class="form-check-label">Poza produsului</label>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-check-label">Preț</label>
...
<script>
    function onsubmit(event) {
        ...
        data.append("pret", document.querySelector("#pret").value)
        fetch("adaugaprodus.php", {method: "post", body: data})
            .then(response => response.text())
            .then(b => {
                if(b === "Imagine încărcată cu succes.")
                    window.location.href = "management-evidenta_produse.php"
            })
