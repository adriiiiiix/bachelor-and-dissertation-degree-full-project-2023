    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Adaugă</strong> webinar</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='management-evidenta_webinarii.php'"><b>ÎNAPOI</b>
                                            </button>
                                        </div>
                                        <div class="card-body">
                                            <form action="adaugawebinar.php" method="POST">
                                                <div class="mb-3">
