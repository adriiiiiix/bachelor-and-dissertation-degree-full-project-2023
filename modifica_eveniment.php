    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Modifică</strong> eveniment</h1>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <!-- <form action="modificaeveniment.php" method="POST" enctype="multipart/form-data">-->
                                            <form id="form">
                                                <div class="mb-3">
...
<script>
    function onsubmit(event) {
        ...
        fetch("modificaeveniment.php", {method: "post", body: data})
            .then(response => response.text())
            .then(b => {
                if(b === "Modificarea a fost efectuată cu succes.")
