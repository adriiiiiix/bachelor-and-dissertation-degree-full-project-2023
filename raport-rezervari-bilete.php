        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <!-- <h1 class="h3 mb-3"><strong>Raport</strong> rezervări bilete</h1> -->
                    <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <script type="text/javascript">
                                                function bilete() {
                                                    ...
                                                    var opt = {
                                                        margin: 0.3,
                                                        filename: `raport rezervari bilete ${new Date().toISOString().slice(0, 10)}`,
                                            ...
                                            <center>
                                                <button onclick="bilete()" id="exportButton"
