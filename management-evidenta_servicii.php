    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Management</strong> și evidență servicii</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='adauga_servicii.php'"><b>ADAUGĂ</b>
                                            </button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='modfica_servicii.php'">
                                                <b>ACTUALIZEAZĂ</b></button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='sterge_servicii.php'"><b>ȘTERGE</b>
                                            </button>
                                        </div>
                    ...
                    <td>" . $z['Cod_Furnizor'] . "</td>
                                        ...
                                        <script type="text/javascript">
                                            function rezervarebilet() {
                                                ...
                                                var opt = {
                                                    margin: 0.3,
                                                    filename: `raport servicii${new Date().toISOString().slice(0, 10)}`,
                                        ...
                                        <center>
                                            <button onclick="servicii()" id="exportButton"
