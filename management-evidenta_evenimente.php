                    ...
                    <div class="col-xl-6 col-xxl-5 d-flex">
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='adauga_eveniment.php'"><b>ADAUGĂ</b>
                                            </button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='modifica_eveniment.php'">
                                                <b>ACTUALIZEAZĂ</b></button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='sterge_eveniment.php'"><b>ȘTERGE</b>
                                            </button>
                                            <br><br>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #704fab; color: white;"
                                                    onclick="document.location='management-evidenta_webinarii.php'"><b>>>>>>></b>
                                            </button>
                                        </div>
                                        <div class="card-body" id="print">
                                            <?php

                                            $x = mysqli_query($con, "SELECT * FROM Eveniment ORDER BY ID;");
                        ...
                        <tr>";
                                            ...
                                            while ($z = mysqli_fetch_assoc($x)) {
                                                echo "<tr>
                          <td>" . $z['ID'] . "</td>
						  <td>" . '<img src = "data:images/png;base64,' . base64_encode($z['Imagine']) . '" width = "50px" height = "50px"/>' . "</td>
                          <td>" . $z['Denumire'] . "</td>
                          <td>" . $z['Perioada'] . "</td>
                          <td>" . $z['Ora'] . "</td>
						  <td>" . $z['Detalii'] . "</td>
