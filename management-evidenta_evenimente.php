    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Management</strong> și evidență evenimente</h1>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                            ...
                                            <div id="modal-add" class="modal">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="form-add-event" enctype="multipart/form-data" onsubmit="addEvent(event)">
                                                            <input type="text" id="modal-add-title" name="title" class="form-control mb-3" placeholder="Titlul evenimentului" required>
                                                            <input type="text" id="modal-add-category" name="category" class="form-control mb-3" placeholder="Categoria" required>
                                                            <textarea id="modal-add-description" name="description" class="form-control mb-3" placeholder="Descrierea evenimentului" required></textarea>
                                                ...
                                                <div id="modal-edit" class="modal">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="form-edit-event" enctype="multipart/form-data" onsubmit="editEvent(event)" method="POST">
                                                            <input type="text" id="modal-edit-id" name="id" placeholder="ID eveniment">
                                                            <input type="text" id="modal-edit-title" name="title" class="form-control mb-3" placeholder="Titlul evenimentului" required>
                                                            <input type="text" id="modal-edit-category" name="category" class="form-control mb-3" placeholder="Categoria" required>
                                                            <textarea id="modal-edit-description" name="description" class="form-control mb-3" placeholder="Descrierea evenimentului" required></textarea>
                                                ...
                                                <div id="modal-delete" class="modal">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="form-delete-event" onsubmit="deleteEvent(event)">
                                                            <input type="text" id="modal-delete-id" name="id" placeholder="ID Eveniment">
                                        ...
                                        <div class="card-body" id="print">
                                            ...
                                            $x = mysqli_query($con, "SELECT * FROM Evenimente ORDER BY ID;");
                                        ...
                                        <script type="text/javascript">
                                            function evidentaevenimente() {
                                                ...
                                                var opt = {
                                                    margin: 0.3,
                                                    filename: `raport-evidenta-evenimente${new Date().toISOString().slice(0, 10)}`,
