...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($id) {
        // Update event
        if ($imagePath) {
            $sql = "UPDATE Produs SET Titlu='$title', Categorie='$category', Descriere='$description', Imagine='$imagePath' WHERE ID=$id";
        } else {
            $sql = "UPDATE Produs SET Titlu='$title', Categorie='$category', Descriere='$description' WHERE ID=$id";
        }
