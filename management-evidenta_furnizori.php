    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Management</strong> și evidență furnizori</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='adauga_furnizori.php'"><b>ADAUGĂ</b>
                                            </button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='modifica_furnizori.php'">
                                                <b>ACTUALIZEAZĂ</b></button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='sterge_furnizori.php'"><b>ȘTERGE</b>
                                            </button>
                                        </div>
                                        <div class="card-body" id="print">
                                            <?php

                                            $x = mysqli_query($con, "SELECT * FROM Furnizor ORDER BY Cod_Furnizor;");
                    ...
                    <td>" . $z['Telefon'] . "</td>
                                        ...
                                        <script type="text/javascript">
                                            function rezervarebilet() {
                                                ...
                                                var opt = {
                                                    margin: 0.3,
                                                    filename: `raport furnizori${new Date().toISOString().slice(0, 10)}`,
                                        ...
                                        <center>
                                            <button onclick="furnizori()" id="exportButton"
