    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Adaugă</strong> serviciu</h1>
                <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='management-evidenta_servicii.php'"><b>ÎNAPOI</b>
                                            </button>
                                        </div>
                                        <div class="card-body">
                                            <form action="adaugaservicii.php" method="POST">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-check-label">Furnizor</label>
                                                    <input type="text" name="furnizor">
                                                </div>
                                                <div class="mb-3">
                                                    <br>
