                    ...
                    <div class="col-xl-6 col-xxl-5 d-flex">
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='adauga_produs.php'"><b>ADAUGĂ</b>
                                            </button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='modifica_produs.php'">
                                                <b>ACTUALIZEAZĂ</b></button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='sterge_produs.php'"><b>ȘTERGE</b>
                                            </button>
                                        </div>
                                        <div class="card-body" id="print">
                                            <?php

                                            $x = mysqli_query($con, "SELECT * FROM Produs ORDER BY Cod_Produs;");
                        ...
                        <tr>";
                          ...
                          <td>" . $z['Pret'] . "</td>
                                        ...
                                        <center>
                                            <button onclick="evidentaproduse()" id="exportButton"
