    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Adaugă</strong> eveniment</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='management-evidenta_evenimente.php'"><b>ÎNAPOI</b>
                                            </button>
                                        </div>
                                        <div class="card-body">
                                            <!-- <form action="adaugaeveniment.php" method="POST" enctype="multipart/form-data">-->
                                            <form id="form">
                                                <div class="mb-3">
                                                    <label class="form-check-label">Poza evenimentului</label>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-check-label">Perioada</label>
                                                    <input type="text" name="perioada" id="perioada">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-check-label">Ora</label>
                                                    <input type="time" name="ora" id="ora">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-check-label">Detalii</label>
                                                    <input type="text" name="detalii" id="detalii">
                                                </div>
                                                <div class="mb-3">
                                                    <br>
                                                    <button type="submit" name="add"
                                                            class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                            style="background: #0d9443; color: white;"><b>SALVEAZĂ
                                                            EVENIMENT</b></button>
                                                </div>
                                            </form>
                                        </div>
...
<script>
    function onsubmit(event) {
        ...
        data.append("imagine", document.querySelector("#imagine").files[0])
        data.append("denumire", document.querySelector("#denumire").value)
        data.append("perioada", document.querySelector("#perioada").value)
        data.append("ora", document.querySelector("#ora").value)
        data.append("detalii", document.querySelector("#detalii").value)
        fetch("adaugaeveniment.php", {method: "post", body: data})
            .then(response => response.text())
            .then(b => {
                if(b === "Imagine încărcată cu succes.")
                    window.location.href = "management-evidenta_evenimente.php"
            })
