    ...
    <div class="main">
        ...
        <main class="content">
            <div class="container-fluid p-0">
                ...
                <h1 class="h3 mb-3"><strong>Management</strong> și evidență webinarii</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header" align="center">
                                            ...
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    ...
                                                    onclick="document.location='adauga_webinar.php'"><b>ADAUGĂ</b>
                                            </button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='modifica_webinar.php'">
                                                <b>ACTUALIZEAZĂ</b></button>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #ab0c1e; color: white;"
                                                    onclick="document.location='sterge_webinar.php'"><b>ȘTERGE</b>
                                            </button>
                                            <br><br>
                                            <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn"
                                                    id="add-task" style="background: #704fab; color: white;"
                                                    onclick="document.location='management-evidenta_evenimente.php'"><b><<<<<<</b>
                                            </button>
                                        </div>
                                        <div class="card-body" id="print">
                                            <?php

                                            $x = mysqli_query($con, "SELECT * FROM Webinar ORDER BY ID;");
                                 ...
                                 <td>" . $z['Ora'] . "</td>
                                        ...
                                        <script type="text/javascript">
                                            function evidentawebinarii() {
                                                ...
                                                var opt = {
                                                    margin: 0.3,
                                                    filename: `raport-evidenta-webinarii${new Date().toISOString().slice(0, 10)}`,
                                        ...
                                        <center>
                                            <button onclick="evidentawebinarii()" id="exportButton"
